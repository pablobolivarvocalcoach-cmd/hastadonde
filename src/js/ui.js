...
function mostrarResultado() {
  ...
  $('res').innerHTML = `
    <div style="margin-top:40px">
      ...
      <h2 style="font-size:clamp(26px,4.6vw,42px);max-width:20ch">${titular(r)}</h2>
      ...
      ${r.indemnizacion === 0 ? `<div class="aviso"><b>Con estos números la indemnización sería cero.</b>
...
function titular(r) {
  if (r.indemnizacion === 0) return 'Con estos números, la póliza no pagaría nada.';
...
function generarRespuestas(d, r) {
  ...
  a.push(['¿Por qué el deducible es tan alto?',
